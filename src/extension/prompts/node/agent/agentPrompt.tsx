			...
			<>
				<UserMessage>
					...
					<Tag name='reminderInstructions'>
						...
						{hasReplaceStringTool && <>For maximum efficiency, whenever you perform multiple edit operations using {ToolName.ReplaceString} tool, invoke them simultaneously rather than sequentially. This would greatly improve efficiency and user waiting time.<br /></>}
					</Tag>
